...
var _prattl$markets$App_Types$FarmersMarketResponse = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _prattl$markets$App_Types$FarmersMarketDetails = F4(
	function (a, b, c, d) {
		return {address: a, googleLink: b, product: c, schedule: d};
	});
var _prattl$markets$App_Types$FarmersMarket = F5(
	function (a, b, c, d, e) {
		return {id: a, distance: b, name: c, details: d, expanded: e};
	});
var _prattl$markets$App_Types$Model = F5(
	function (a, b, c, d, e) {
		return {activeTab: a, error: b, loading: c, results: d, zipCode: e};
	});
var _prattl$markets$App_Types$ResultsMap = {ctor: 'ResultsMap'};
var _prattl$markets$App_Types$ResultsTable = {ctor: 'ResultsTable'};
var _prattl$markets$App_Types$ReceiveDetails = F2(
	function (a, b) {
		return {ctor: 'ReceiveDetails', _0: a, _1: b};
	});
var _prattl$markets$App_Types$OpenMoreInfo = function (a) {
	return {ctor: 'OpenMoreInfo', _0: a};
};
var _prattl$markets$App_Types$ReceiveSearchResults = function (a) {
	return {ctor: 'ReceiveSearchResults', _0: a};
};
var _prattl$markets$App_Types$SubmitSearch = {ctor: 'SubmitSearch'};
var _prattl$markets$App_Types$ChangeZip = function (a) {
	return {ctor: 'ChangeZip', _0: a};
};
var _prattl$markets$App_Types$ChangeTab = function (a) {
	return {ctor: 'ChangeTab', _0: a};
};

var _prattl$markets$App_Update$calculateError = function (results) {
	var result = _elm_lang$core$List$head(results);
	var _p0 = result;
	if (_p0.ctor === 'Just') {
		return _elm_lang$core$Native_Utils.eq(_p0._0.id, 'Error');
	} else {
		return false;
	}
};
var _prattl$markets$App_Update$initFarmersMarket = F2(
	function (id_, marketname) {
		var name = A2(
			_elm_lang$core$String$join,
			' ',
			A2(
				...
				1,
				A2(_elm_lang$core$String$split, ' ', marketname)));
		var distance = function () {
			var dist_ = _elm_lang$core$List$head(
				A2(_elm_lang$core$String$split, ' ', marketname));
			var _p1 = dist_;
			if (_p1.ctor === 'Just') {
				return _p1._0;
		...
		return A5(_prattl$markets$App_Types$FarmersMarket, id_, distance, name, _elm_lang$core$Maybe$Nothing, false);
	});
var _prattl$markets$App_Update$responseToFarmersMarket = function (response) {
	return A2(_prattl$markets$App_Update$initFarmersMarket, response.id, response.name);
};
var _prattl$markets$App_Update$decodeDetails = A5(
	_elm_lang$core$Json_Decode$map4,
	_prattl$markets$App_Types$FarmersMarketDetails,
	A2(_elm_lang$core$Json_Decode$field, 'Address', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'GoogleLink', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'Products', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'Schedule', _elm_lang$core$Json_Decode$string));
var _prattl$markets$App_Update$decodeDetailsResponse = A2(_elm_lang$core$Json_Decode$field, 'marketdetails', _prattl$markets$App_Update$decodeDetails);
var _prattl$markets$App_Update$getFarmersMarketDetailsIfNeeded = function (farmersMarket) {
	var url = A2(_elm_lang$core$Basics_ops['++'], 'https://search.ams.usda.gov/farmersmarkets/v1/data.svc/mktDetail?id=', farmersMarket.id);
	var request = A2(_elm_lang$http$Http$get, url, _prattl$markets$App_Update$decodeDetailsResponse);
	var _p2 = farmersMarket.details;
	if (_p2.ctor === 'Just') {
		return _elm_lang$core$Platform_Cmd$none;
	} else {
		return A2(
			_elm_lang$http$Http$send,
			_prattl$markets$App_Types$ReceiveDetails(farmersMarket.id),
			request);
	}
};
var _prattl$markets$App_Update$decodeFarmersMarket = A3(
	_elm_lang$core$Json_Decode$map2,
	_prattl$markets$App_Types$FarmersMarketResponse,
	A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'marketname', _elm_lang$core$Json_Decode$string));
var _prattl$markets$App_Update$decodeFarmersMarketResponse = A2(
	_elm_lang$core$Json_Decode$field,
	'results',
	_elm_lang$core$Json_Decode$list(_prattl$markets$App_Update$decodeFarmersMarket));
var _prattl$markets$App_Update$getFarmersMarketsByZip = function (zipCode) {
	var url = A2(_elm_lang$core$Basics_ops['++'], 'https://search.ams.usda.gov/farmersmarkets/v1/data.svc/zipSearch?zip=', zipCode);
	var request = A2(_elm_lang$http$Http$get, url, _prattl$markets$App_Update$decodeFarmersMarketResponse);
	return A2(_elm_lang$http$Http$send, _prattl$markets$App_Types$ReceiveSearchResults, request);
};
var _prattl$markets$App_Update$toggleFarmersMarketExpanded = F2(
	function (farmersMarket, list) {
		var toggle = function (result) {
			return _elm_lang$core$Native_Utils.eq(farmersMarket.id, result.id) ? _elm_lang$core$Native_Utils.update(
				result,
				{expanded: !result.expanded}) : result;
		};
		return A2(_elm_lang$core$List$map, toggle, list);
	});
var _prattl$markets$App_Update$updateFarmersMarketDetails = F3(
	function (farmersMarketIdToUpdate, details, list) {
		var addDetails = function (farmersMarket) {
			return _elm_lang$core$Native_Utils.eq(farmersMarketIdToUpdate, farmersMarket.id) ? _elm_lang$core$Native_Utils.update(
				farmersMarket,
				{
					details: _elm_lang$core$Maybe$Just(details)
				}) : farmersMarket;
		};
		return A2(_elm_lang$core$List$map, addDetails, list);
	});
var _prattl$markets$App_Update$update = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'ChangeTab':
			...
			case 'SubmitSearch':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{loading: true}),
					_1: _prattl$markets$App_Update$getFarmersMarketsByZip(model.zipCode)
				};
			case 'ReceiveSearchResults':
				if (_p3._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: function () {
							var resultsList = A2(_elm_lang$core$List$map, _prattl$markets$App_Update$responseToFarmersMarket, _p3._0._0);
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									error: _prattl$markets$App_Update$calculateError(resultsList),
									loading: false,
									results: _elm_lang$core$Maybe$Just(resultsList)
								});
						}(),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'OpenMoreInfo':
				...
				var updatedResults = function () {
					var _p4 = model.results;
					if (_p4.ctor === 'Just') {
						return _elm_lang$core$Maybe$Just(
							A2(_prattl$markets$App_Update$toggleFarmersMarketExpanded, _p5, _p4._0));
					} else {
						return _elm_lang$core$Maybe$Nothing;
					}
				}();
				return {
					...
					_1: _prattl$markets$App_Update$getFarmersMarketDetailsIfNeeded(_p5)
				};
			default:
				if (_p3._1.ctor === 'Ok') {
					var updatedModel = function () {
						...
						if (_p6.ctor === 'Just') {
							return _elm_lang$core$Native_Utils.update(
								...
								{
									results: _elm_lang$core$Maybe$Just(
										A3(_prattl$markets$App_Update$updateFarmersMarketDetails, _p3._0, _p3._1._0, _p6._0))
								});
						} else {
							return model;
						}
...
var _prattl$markets$Forms_ZipSearchForm$baseModifiers = _elm_lang$core$Native_Utils.update(
	_surprisetalk$elm_bulma$Bulma_Elements$buttonModifiers,
	{size: _surprisetalk$elm_bulma$Bulma_Modifiers$Large, color: _surprisetalk$elm_bulma$Bulma_Modifiers$Info});
var _prattl$markets$Forms_ZipSearchForm$searchButtonModifiers = function (_p0) {
	var _p1 = _p0;
	return _p1.loading ? _elm_lang$core$Native_Utils.update(
		_prattl$markets$Forms_ZipSearchForm$baseModifiers,
		{state: _surprisetalk$elm_bulma$Bulma_Modifiers$Loading}) : _prattl$markets$Forms_ZipSearchForm$baseModifiers;
};
var _prattl$markets$Forms_ZipSearchForm$searchButton = function (model) {
	return A4(
		_surprisetalk$elm_bulma$Bulma_Form$controlButton,
		_prattl$markets$Forms_ZipSearchForm$searchButtonModifiers(model),
		{ctor: '[]'},
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A3(
				_surprisetalk$elm_bulma$Bulma_Elements$icon,
				_surprisetalk$elm_bulma$Bulma_Modifiers$Medium,
				{ctor: '[]'},
				{
					ctor: '::',
					_0: A2(
...
var _prattl$markets$Forms_ZipSearchForm$searchInput = function (model) {
	return A3(
		_surprisetalk$elm_bulma$Bulma_Form$connectedFields,
		_surprisetalk$elm_bulma$Bulma_Modifiers$Centered,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A4(
				...
				_elm_lang$core$Native_Utils.update(
					...
					{size: _surprisetalk$elm_bulma$Bulma_Modifiers$Large}),
				{ctor: '[]'},
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_prattl$markets$App_Types$ChangeZip),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$placeholder('Zip code'),
						_1: {
							ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _prattl$markets$Forms_ZipSearchForm$searchButton(model),
				_1: {ctor: '[]'}
			}
		});
};
var _prattl$markets$Forms_ZipSearchForm$zipSearchForm = function (model) {
	return A3(
		_surprisetalk$elm_bulma$Bulma_Layout$section,
		_surprisetalk$elm_bulma$Bulma_Layout$NotSpaced,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A2(
				_surprisetalk$elm_bulma$Bulma_Layout$container,
				{ctor: '[]'},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onSubmit(_prattl$markets$App_Types$SubmitSearch),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _prattl$markets$Forms_ZipSearchForm$searchInput(model),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _prattl$markets$Layout_Header$marketsHero = A3(
	_surprisetalk$elm_bulma$Bulma_Layout$hero,
	_elm_lang$core$Native_Utils.update(
		_surprisetalk$elm_bulma$Bulma_Layout$heroModifiers,
		{size: _surprisetalk$elm_bulma$Bulma_Modifiers$Small, color: _surprisetalk$elm_bulma$Bulma_Modifiers$Primary}),
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			_surprisetalk$elm_bulma$Bulma_Layout$heroBody,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: A3(
							_surprisetalk$elm_bulma$Bulma_Elements$title,
							_surprisetalk$elm_bulma$Bulma_Elements$H1,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('is-size-3-mobile'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Farmer\'s Market Locator'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A3(
								_surprisetalk$elm_bulma$Bulma_Elements$subtitle,
								_surprisetalk$elm_bulma$Bulma_Elements$H2,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('is-size-4-mobile'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Find a Farmer\'s Market Near You '),
											_1: {
												ctor: '::',
												_0: A3(
													_surprisetalk$elm_bulma$Bulma_Elements$icon,
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('has-text-warning'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('fas fa-map-marker-alt'),
																_1: {ctor: '[]'}
															},
															{ctor: '[]'}),
														_1: {ctor: '[]'}
...
var _prattl$markets$Layout_Header$appHeader = _prattl$markets$Layout_Header$marketsHero;

var _surprisetalk$elm_bulma$Bulma_Columns$narrowColumnModifiers = {
	offset: _surprisetalk$elm_bulma$Bulma_Modifiers$Auto,
	widths: {mobile: _elm_lang$core$Maybe$Nothing, tablet: _elm_lang$core$Maybe$Nothing, desktop: _elm_lang$core$Maybe$Nothing, widescreen: _elm_lang$core$Maybe$Nothing, fullHD: _elm_lang$core$Maybe$Nothing}
};
var _surprisetalk$elm_bulma$Bulma_Columns$columnModifiers = {
	offset: _surprisetalk$elm_bulma$Bulma_Modifiers$Auto,
	widths: {
		mobile: _elm_lang$core$Maybe$Just(_surprisetalk$elm_bulma$Bulma_Modifiers$Auto),
		tablet: _elm_lang$core$Maybe$Just(_surprisetalk$elm_bulma$Bulma_Modifiers$Auto),
		desktop: _elm_lang$core$Maybe$Just(_surprisetalk$elm_bulma$Bulma_Modifiers$Auto),
		widescreen: _elm_lang$core$Maybe$Just(_surprisetalk$elm_bulma$Bulma_Modifiers$Auto),
		fullHD: _elm_lang$core$Maybe$Just(_surprisetalk$elm_bulma$Bulma_Modifiers$Auto)
	}
};
var _surprisetalk$elm_bulma$Bulma_Columns$column = function (_p0) {
	var _p1 = _p0;
	var _p8 = _p1.widths;
	return A3(
		_surprisetalk$elm_bulma$Helpers$node,
		...
		{
			ctor: '::',
			_0: _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.container,
			_1: {
				ctor: '::',
				_0: function () {
					var _p2 = _p8.mobile;
						...
						switch (_p2._0.ctor) {
							...
							case 'Width1':
								return A3(
									...
									'-mobile',
									_danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.width.is1);
							case 'Width2':
								return A3(
									_elm_lang$core$Basics$flip,
									F2(
									...
									'-mobile',
									_danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.width.is2);
							case 'Width3':
								return A3(
									_elm_lang$core$Basics$flip,
									F2(
									...
									'-mobile',
									_danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.width.is3);
							case 'Width4':
								return A3(
									_elm_lang$core$Basics$flip,
									F2(
									...
									'-mobile',
									_danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.width.is4);
							case 'Width5':
								return A3(
									_elm_lang$core$Basics$flip,
									F2(
									...
									'-mobile',
									_danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.width.is5);
							case 'Width6':
								return A3(
									_elm_lang$core$Basics$flip,
									F2(
									...
									'-mobile',
									_danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.width.is6);
							case 'Width7':
								return A3(
									_elm_lang$core$Basics$flip,
									F2(
									...
									'-mobile',
									_danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.width.is7);
							case 'Width8':
								return A3(
									_elm_lang$core$Basics$flip,
									F2(
									...
									'-mobile',
									_danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.width.is8);
							case 'Width9':
								return A3(
									_elm_lang$core$Basics$flip,
									F2(
									...
									'-mobile',
									_danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.width.is9);
							case 'Width10':
								return A3(
									_elm_lang$core$Basics$flip,
									F2(
									...
									'-mobile',
									_danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.width.is10);
							default:
								return A3(
									_elm_lang$core$Basics$flip,
									F2(
									...
									'-mobile',
									_danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.width.is11);
						}
					} else {
						return A3(
							_elm_lang$core$Basics$flip,
									...
									_0: function () {
										...
										switch (_p7.ctor) {
											case 'Auto':
												return '';
											case 'Width1':
												return _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.offset.is1;
											case 'Width2':
												return _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.offset.is2;
											case 'Width3':
												return _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.offset.is3;
											case 'Width4':
												return _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.offset.is4;
											case 'Width5':
												return _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.offset.is5;
											case 'Width6':
												return _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.offset.is6;
											case 'Width7':
												return _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.offset.is7;
											case 'Width8':
												return _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.offset.is8;
											case 'Width9':
												return _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.offset.is9;
											case 'Width10':
												return _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.offset.is10;
											default:
												return _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.column.offset.is11;
										}
									}(),
									_1: {ctor: '[]'}
								}
...
var _surprisetalk$elm_bulma$Bulma_Columns$columns = function (_p9) {
	var _p10 = _p9;
	return A3(
		_surprisetalk$elm_bulma$Helpers$node,
		'div',
		...
		{
			ctor: '::',
			_0: _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.container,
			_1: {
				ctor: '::',
				_0: function () {
					var _p11 = _p10.centered;
					if (_p11 === true) {
						return 'is-centered';
					} else {
						return '';
				...
				_1: {
					ctor: '::',
					_0: function () {
						var _p12 = _p10.multiline;
						if (_p12 === true) {
							return _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.spacing.isMultiline;
						} else {
							return '';
						}
					}(),
					_1: {
						...
						_0: function () {
							...
							switch (_p13.ctor) {
								case 'Gap0':
									return 'is-variable is-0 is-gapless';
								case 'Gap1':
									return 'is-variable is-1';
								case 'Gap2':
									return 'is-variable is-2';
								case 'Gap3':
									return 'is-variable is-3';
								case 'Gap4':
									return 'is-variable is-4';
								case 'Gap5':
									return 'is-variable is-5';
								case 'Gap6':
									return 'is-variable is-6';
								case 'Gap7':
									return 'is-variable is-7';
								default:
									return 'is-variable is-8';
							}
						}(),
						_1: {
							ctor: '::',
							_0: function () {
								var _p14 = _p10.display;
								switch (_p14.ctor) {
									case 'MobileAndBeyond':
										return _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.display.onMobile;
									case 'TabletAndBeyond':
										return '';
									default:
										return _danielnarey$elm_bulma_classes$BulmaClasses$bulma.columns.display.onlyDesktop;
								}
							}(),
							_1: {ctor: '[]'}
						}
...
var _surprisetalk$elm_bulma$Bulma_Columns$ColumnsModifiers = F4(
	function (a, b, c, d) {
		return {multiline: a, gap: b, display: c, centered: d};
	});
var _surprisetalk$elm_bulma$Bulma_Columns$ColumnModifiers = F2(
	function (a, b) {
		return {offset: a, widths: b};
	});
var _surprisetalk$elm_bulma$Bulma_Columns$Gap8 = {ctor: 'Gap8'};
var _surprisetalk$elm_bulma$Bulma_Columns$Gap7 = {ctor: 'Gap7'};
var _surprisetalk$elm_bulma$Bulma_Columns$Gap6 = {ctor: 'Gap6'};
var _surprisetalk$elm_bulma$Bulma_Columns$Gap5 = {ctor: 'Gap5'};
var _surprisetalk$elm_bulma$Bulma_Columns$Gap4 = {ctor: 'Gap4'};
var _surprisetalk$elm_bulma$Bulma_Columns$Gap3 = {ctor: 'Gap3'};
var _surprisetalk$elm_bulma$Bulma_Columns$Gap2 = {ctor: 'Gap2'};
var _surprisetalk$elm_bulma$Bulma_Columns$Gap1 = {ctor: 'Gap1'};
var _surprisetalk$elm_bulma$Bulma_Columns$Gap0 = {ctor: 'Gap0'};
var _surprisetalk$elm_bulma$Bulma_Columns$DesktopAndBeyond = {ctor: 'DesktopAndBeyond'};
var _surprisetalk$elm_bulma$Bulma_Columns$TabletAndBeyond = {ctor: 'TabletAndBeyond'};
var _surprisetalk$elm_bulma$Bulma_Columns$columnsModifiers = {multiline: false, gap: _surprisetalk$elm_bulma$Bulma_Columns$Gap3, display: _surprisetalk$elm_bulma$Bulma_Columns$TabletAndBeyond, centered: false};
var _surprisetalk$elm_bulma$Bulma_Columns$MobileAndBeyond = {ctor: 'MobileAndBeyond'};

var _prattl$markets$Views_SearchResults_Map$searchResultsMap = function (model) {
	return _elm_lang$html$Html$text('Map');
};

var _prattl$markets$Views_SearchResults_Table$moreInfoButton = function (farmersMarket) {
	var iconClass = function () {
		var _p0 = farmersMarket.expanded;
		if (_p0 === true) {
	...
	return A2(
		_elm_lang$html$Html$a,
		{
			...
			_0: _elm_lang$html$Html_Events$onClick(
				_prattl$markets$App_Types$OpenMoreInfo(farmersMarket)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A3(
				_surprisetalk$elm_bulma$Bulma_Elements$icon,
				_surprisetalk$elm_bulma$Bulma_Modifiers$Small,
				{ctor: '[]'},
				{
					ctor: '::',
					_0: A2(
...
var _prattl$markets$Views_SearchResults_Table$detailTitle = function (name) {
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('has-text-weight-bold'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _prattl$markets$Views_SearchResults_Table$googleLink = function (to) {
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Google Maps link '),
			_1: {
				ctor: '::',
				_0: A3(
					_surprisetalk$elm_bulma$Bulma_Elements$icon,
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('fas fa-external-link-alt'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
...
var _prattl$markets$Views_SearchResults_Table$farmersMarketDetails = function (details) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('columns is-desktop'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('column is-three-fifths is-offset-one-fifth'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(details.address),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text(' ('),
												_1: {
													ctor: '::',
													_0: _prattl$markets$Views_SearchResults_Table$googleLink(details.googleLink),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(')'),
														_1: {ctor: '[]'}
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _prattl$markets$Views_SearchResults_Table$detailTitle('Products: '),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html$text(details.product),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _prattl$markets$Views_SearchResults_Table$detailTitle('Schedule: '),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(details.schedule),
														_1: {ctor: '[]'}
													}
												}),
											_1: {ctor: '[]'}
...
var _prattl$markets$Views_SearchResults_Table$farmersMarketDetailsRow = function (farmersMarket) {
	var _p1 = farmersMarket.expanded;
	if (_p1 === true) {
		return A3(
				...
				_0: function () {
					...
					if (_p2.ctor === 'Just') {
						return A2(
							...
							{
								ctor: '::',
								_0: _prattl$markets$Views_SearchResults_Table$farmersMarketDetails(_p2._0),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
								...
								_0: A3(
									...
									_surprisetalk$elm_bulma$Bulma_Modifiers$Medium,
									{
										...
										_0: _elm_lang$html$Html_Attributes$style(
											{
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'margin', _1: '2rem 0'},
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('fas fa-sync fa-spin fa-lg'),
												_1: {ctor: '[]'}
											},
											{ctor: '[]'}),
										_1: {ctor: '[]'}
...
var _prattl$markets$Views_SearchResults_Table$searchResultsRow = F2(
	function (model, farmersMarket) {
		return {
			ctor: '::',
			_0: A3(
				_surprisetalk$elm_bulma$Bulma_Elements$tableRow,
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(farmersMarket.distance),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(farmersMarket.name),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _prattl$markets$Views_SearchResults_Table$moreInfoButton(farmersMarket),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
			...
			_1: {
				ctor: '::',
				_0: _prattl$markets$Views_SearchResults_Table$farmersMarketDetailsRow(farmersMarket),
				_1: {ctor: '[]'}
			}
		};
	});
var _prattl$markets$Views_SearchResults_Table$searchResultsBody = function (model) {
	return A2(
		_surprisetalk$elm_bulma$Bulma_Elements$tableBody,
		{ctor: '[]'},
		function () {
			var _p3 = model.results;
			if (_p3.ctor === 'Just') {
				return A3(
					_elm_lang$core$List$foldr,
					F2(
					...
					A2(
						_elm_lang$core$List$map,
						_prattl$markets$Views_SearchResults_Table$searchResultsRow(model),
						_p3._0));
			} else {
				return {ctor: '[]'};
			}
...
var _prattl$markets$Views_SearchResults_Table$searchResultsTable = function (model) {
	return A3(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _prattl$markets$Views_SearchResults_Table$searchResultsBody(model),
				_1: {ctor: '[]'}
			}
		});
};

var _prattl$markets$Views_SearchResults_Contents$errorMessage = A3(
	_surprisetalk$elm_bulma$Bulma_Columns$columns,
	_elm_lang$core$Native_Utils.update(
		_surprisetalk$elm_bulma$Bulma_Columns$columnsModifiers,
		{centered: true}),
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A3(
			_surprisetalk$elm_bulma$Bulma_Columns$column,
			_surprisetalk$elm_bulma$Bulma_Columns$columnModifiers,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('is-half is-narrow'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A3(
					_surprisetalk$elm_bulma$Bulma_Elements$notification,
					_surprisetalk$elm_bulma$Bulma_Modifiers$Danger,
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('No results were found. Try a different ZIP code.'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}),
...
var _prattl$markets$Views_SearchResults_Contents$numSearchResults = function (model) {
	...
	if (_p0.ctor === 'Just') {
		return A2(
			...
			},
			{
				...
				_0: _elm_lang$html$Html$text(
					_elm_lang$core$Basics$toString(
						_elm_lang$core$List$length(_p0._0))),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(' results found'),
					_1: {ctor: '[]'}
				}
			});
	} else {
...
var _prattl$markets$Views_SearchResults_Contents$renderTabContents = function (model) {
	var _p1 = model.activeTab;
	if (_p1.ctor === 'ResultsTable') {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: _prattl$markets$Views_SearchResults_Contents$numSearchResults(model),
				_1: {
					ctor: '::',
					_0: _prattl$markets$Views_SearchResults_Table$searchResultsTable(model),
					_1: {ctor: '[]'}
				}
			});
	} else {
		return _prattl$markets$Views_SearchResults_Map$searchResultsMap(model);
	}
};
var _prattl$markets$Views_SearchResults_Contents$searchResultsContents = function (model) {
	return A2(
		...
		},
		{
			...
			_0: function () {
				var _p2 = model.error;
				if (_p2 === true) {
					return _prattl$markets$Views_SearchResults_Contents$errorMessage;
				} else {
					var _p3 = model.results;
					if (_p3.ctor === 'Just') {
						return _prattl$markets$Views_SearchResults_Contents$renderTabContents(model);
					} else {
						return _elm_lang$html$Html$text('');
					}
				}
...
var _prattl$markets$Views_SearchResults_Tabs$tabMods = A3(_surprisetalk$elm_bulma$Bulma_Components$TabsModifiers, _surprisetalk$elm_bulma$Bulma_Components$Boxed, _surprisetalk$elm_bulma$Bulma_Modifiers$Left, _surprisetalk$elm_bulma$Bulma_Modifiers$Large);
var _prattl$markets$Views_SearchResults_Tabs$renderTab = F2(
	function (activeTab, _p0) {
		var _p1 = _p0;
		var _p2 = _p1.tabContent;
		return A4(
			_surprisetalk$elm_bulma$Bulma_Components$tab,
			_elm_lang$core$Native_Utils.eq(activeTab, _p2),
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_prattl$markets$App_Types$ChangeTab(_p2)),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'},
			{
...
var _prattl$markets$Views_SearchResults_Tabs$TabOption = F2(
	function (a, b) {
		return {node: a, tabContent: b};
	});
var _prattl$markets$Views_SearchResults_Tabs$tabOptions = {
	ctor: '::',
	_0: A2(
		_prattl$markets$Views_SearchResults_Tabs$TabOption,
		A2(
			_elm_lang$html$Html$i,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('fas fa-table'),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'}),
		_prattl$markets$App_Types$ResultsTable),
	_1: {ctor: '[]'}
};
var _prattl$markets$Views_SearchResults_Tabs$renderTabs = function (model) {
	return A2(
		_elm_lang$core$List$map,
		_prattl$markets$Views_SearchResults_Tabs$renderTab(model.activeTab),
		_prattl$markets$Views_SearchResults_Tabs$tabOptions);
};
var _prattl$markets$Views_SearchResults_Tabs$searchResultsTabs = function (model) {
	return A4(
		_surprisetalk$elm_bulma$Bulma_Components$tabs,
		_prattl$markets$Views_SearchResults_Tabs$tabMods,
		{ctor: '[]'},
		{ctor: '[]'},
		_prattl$markets$Views_SearchResults_Tabs$renderTabs(model));
};

var _prattl$markets$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$main_,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _prattl$markets$Layout_Header$appHeader,
			_1: {
				ctor: '::',
				_0: _prattl$markets$Forms_ZipSearchForm$zipSearchForm(model),
				_1: {
					ctor: '::',
					_0: A3(
						_surprisetalk$elm_bulma$Bulma_Layout$section,
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _prattl$markets$Views_SearchResults_Tabs$searchResultsTabs(model),
									_1: {
										ctor: '::',
										_0: _prattl$markets$Views_SearchResults_Contents$searchResultsContents(model),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
...
var _prattl$markets$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _prattl$markets$Main$model = A5(_prattl$markets$App_Types$Model, _prattl$markets$App_Types$ResultsTable, false, false, _elm_lang$core$Maybe$Nothing, '');
var _prattl$markets$Main$init = {ctor: '_Tuple2', _0: _prattl$markets$Main$model, _1: _elm_lang$core$Platform_Cmd$none};
var _prattl$markets$Main$main = _elm_lang$html$Html$program(
	{init: _prattl$markets$Main$init, view: _prattl$markets$Main$view, subscriptions: _prattl$markets$Main$subscriptions, update: _prattl$markets$App_Update$update})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _prattl$markets$Main$main !== 'undefined') {
    _prattl$markets$Main$main(Elm['Main'], 'Main', undefined);
}
